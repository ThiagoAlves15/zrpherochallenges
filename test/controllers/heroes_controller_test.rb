...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heroes_url, params: { hero: { latitude: @hero.latitude, longitude: @hero.longitude, name: @hero.name, rank: @hero.rank } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { latitude: @hero.latitude, longitude: @hero.longitude, name: @hero.name, rank: @hero.rank } }
